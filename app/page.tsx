...
function Credenciais() {
  ...
  return (
    <div className="flex flex-col justify-between h-screen w-screen bg-gradient-to-b from-white to-purple-200 font-signika">
      ...
      <div className="flex flex-col px-4 mt-7 md:mt-10 w-full max-w-md mx-auto">
        <label
          htmlFor="email"
        ...
        <input
          ...
          className="w-full border border-gray-300 focus:outline-none rounded-xl p-2 pl-4 bg-white shadow"
        />
        {/* Mensagem de erro */}
      ...
      <div className="w-full bg-azul text-white mt-10">
        <div className="flex items-center justify-between pt-3 px-4 max-w-screen-xl mx-auto">
          <div className="flex flex-col">
            <div className="mb-2">
              <a
                href="https://vitale.healthysmartcities.pt/"
                className="hover:underline no-underline flex items-center gap-2 text-white"
              >
